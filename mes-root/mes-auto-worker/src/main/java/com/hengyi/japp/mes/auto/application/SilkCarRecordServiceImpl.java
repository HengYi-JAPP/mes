...
public class SilkCarRecordServiceImpl implements SilkCarRecordService {
    ...
    @Inject
    private SilkCarRecordServiceImpl(AuthService authService, SilkCarRecordRepository silkCarRecordRepository, LineRepository lineRepository, SilkCarRepository silkCarRepository, GradeRepository gradeRepository, SilkCarRuntimeRepository silkCarRuntimeRepository, SilkBarcodeRepository silkBarcodeRepository, SilkRepository silkRepository, OperatorRepository operatorRepository) {
