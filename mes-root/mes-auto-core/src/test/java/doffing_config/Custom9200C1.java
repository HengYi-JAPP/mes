...
public class Custom9200C1 {
    ...
    private static LineMachineSpec getLineMachineSpec(int orderBy, SilkCarSideType sideType, int spindleNum) {
        ...
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 1, 1, 14));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 1, 2, 16));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 1, 3, 18));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 1, 4, 20));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 2, 1, 12));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 2, 2, 10));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 2, 3, 8));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 2, 4, 6));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 2, 5, 4));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 2, 6, 2));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 3, 1, 13));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 3, 2, 15));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 3, 3, 17));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 3, 4, 19));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 4, 1, 11));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 4, 2, 9));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 4, 3, 7));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 4, 4, 5));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 4, 5, 3));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 4, 6, 1));
        return result;
    }
}