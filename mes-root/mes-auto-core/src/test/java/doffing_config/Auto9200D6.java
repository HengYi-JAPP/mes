...
public class Auto9200D6 {
    ...
    private static LineMachineSpec getLineMachineSpec(int orderBy, SilkCarSideType sideType, int spindleNum) {
        ...
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 1, 1, 21));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 1, 2, 9));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 1, 3, 17));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 1, 4, 5));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 1, 5, 13));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 1, 6, 1));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 2, 1, 10));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 2, 2, 22));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 2, 3, 6));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 2, 4, 18));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 2, 5, 2));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 2, 6, 14));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 3, 1, 23));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 3, 2, 11));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 3, 3, 19));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 3, 4, 7));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 3, 5, 15));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 3, 6, 3));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 4, 1, 12));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 4, 2, 24));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 4, 3, 8));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 4, 4, 20));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 4, 5, 4));
        lineMachineSilkSpecs.add(lineMachineSilkSpec(sideType, 4, 6, 16));
        return result;
    }
