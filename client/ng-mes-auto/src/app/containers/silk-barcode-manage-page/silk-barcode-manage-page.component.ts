...
@Component({
  templateUrl: './silk-barcode-manage-page.component.html',
  styleUrls: ['./silk-barcode-manage-page.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SilkBarcodeManagePageComponent implements OnInit, OnDestroy {
  @HostBinding('class.app-page') b1 = true;
  @HostBinding('class.app-silk-barcode-manage-page') b2 = true;
  readonly displayedColumns = ['code', 'number', 'rowAndCol', 'note', 'brand', 'supplier', 'btns'];
