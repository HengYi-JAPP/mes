...
@Component({
  templateUrl: './printer-manage-page.component.html',
  styleUrls: ['./printer-manage-page.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class PrinterManagePageComponent implements OnInit, OnDestroy {
  @HostBinding('class.app-page') b1 = true;
  @HostBinding('class.app-printer-manage-page') b2 = true;
